...
def post_obsidian(file_path:str, file_name:str, message:str):
...
def ss_crawler(session_, file_path_,file_name_, ss_url_, published_ids_, query_list_, fields_,
    ...
    for query_ in query_list_:
        ...
        if not len(range_classic_) == 0:
            ...
            post_obsidian(file_path_, file_name_, classicinfo)
        else:
        ...
        while continueflag:
            ...
            for targpaper in summary:
                ...
                if paperID not in published_ids_:
                    ...
                    post_obsidian(file_path_, file_name_, paperinfo)
            ...
            if counter == 0 and len(summary) < Npapers_batch_size_:
                ...
                post_obsidian(file_path_, file_name_, '\n'.join(['--------------------',
                                                                 'No more papers to post!']))
                continueflag = False
                break
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if currenthour == posting_hour and day not in day_off or args.once:
            ...
            post_obsidian(args.obsidian, args.name, 'Hello!')

            # main crawler function
            ss_crawler(session, args.obsidian, args.name, ss_url, published_ids, query_list, fields,
                       Npapers_to_display, Npapers_batch_size)

            if ifClassic:
                # for classic papers
                ss_crawler(session, args.obsidian, args.name, ss_url, published_ids_old, classic_query_list, fields,
